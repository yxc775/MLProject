...
def summarize_performance(epoch, g_model, d_model, dataset, latent_dim, n_samples=100):
    ...
    X_real, y_real = discriminator.pick_real_sample(dataset, n_samples)
    # evaluate discriminator on real examples
    _, acc_real = d_model.evaluate(X_real, y_real, verbose=0)
    # prepare fake examples
    x_fake, y_fake = generator.generate_fake_samples(g_model, latent_dim, n_samples)
...
def train(g_model, d_model, gan_model, dataset, latent_dim, n_epochs=100, n_batch=256):
    ...
    for i in range(n_epochs):
        ...
        for j in range(bat_per_epo):
            ...
            X_real, y_real = discriminator.pick_real_sample(dataset, half_batch)
...
if __name__ == '__main__':
    ...
    # create the gan
    gan_model = ganmodel.define_gan(g_model, d_model)
    # load image data
